...
export default function FolderList() {
  ...
  const [contextMenuFolderId, setContextMenuFolderId] = useState(null);
  ...
  const CreateFolder = () =>
    handleCreateFolder({
      title: newFolderName,
      parentFolderId: contextMenuFolderId,
    });

  const DeleteFolder = () => handleDeleteFolder(contextMenuFolderId);
  ...
  const handleClickInside = (e) => {
    // Ensure click is inside context menu, otherwise close it
