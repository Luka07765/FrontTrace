...
export default function Dashboard() {
  ...
  const [asideMode, setAsideMode] = useState("relative"); // <-- new state
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* new buttons to change aside mode */}
          ...
          <div className="relative z-[1000]">
            <aside
              ...
              className={cn(
                ...
                asideMode // <-- will be either 'relative' or 'absolute'
              )}
              style={{ width: 170 }}
            >
              <div className="p-4">
